...
exports.TOOL_REGISTRY = [
    {
        ...
        handler: async (params, ctx) => (0, midiTools_1.generateMidiMelody)({
            key: params.key,
            scale: params.scale,
            tempo: params.tempo,
            bars: params.bars,
    ...
    },
    {
        ...
        confirmationRequired: false,
        handler: async (params, ctx) => (0, midiTools_1.generateChordProgression)({
            key: params.key,
            scale: params.scale,
    ...
    },
    {
        ...
        confirmationRequired: false,
        handler: async (params, ctx) => (0, midiTools_1.generateDrumPattern)({
    ...
    },
    {
        ...
        parameters: {},
        confirmationRequired: false,
        handler: async (_params, ctx) => (0, midiTools_1.revealProjectFolder)(ctx?.filePath ? require('path').dirname(ctx.filePath) : null),
    },
    {
        ...
        parameters: {},
        confirmationRequired: false,
        handler: async () => (0, midiTools_1.explainImportToFlStudio)(),
    },
    {
        ...
        parameters: {},
        confirmationRequired: false,
        handler: async (_params, ctx) => (0, midiTools_1.summarizeProjectContext)({
...
function fallbackResponse(messages, context) {
